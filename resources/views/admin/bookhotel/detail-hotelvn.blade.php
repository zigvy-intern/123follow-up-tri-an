                        ...
                        <form method="post" id="insert-description">
                          <script>
                            var editor = CKEDITOR.replace('insert-description',{
                              language:'vi',
                              filebrowserBrowseUrl :'source/plugins/ckfinder/ckfinder.html',

                              filebrowserImageBrowseUrl : 'source/plugins/ckfinder/ckfinder.html?type=Images',

                              filebrowserFlashBrowseUrl : 'source/plugins/ckfinder/ckfinder.html?type=Flash',

                              filebrowserUploadUrl : 'source/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',

                              filebrowserImageUploadUrl : 'source/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',

                              filebrowserFlashUploadUrl : 'source/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',

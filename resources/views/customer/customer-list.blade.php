        ...
        <div class="panel-body">
          <div class="row">
            <div class="customer-modal">
              <button class="btn btn-primary " data-toggle="modal" data-target="#modalCustomer" ><i class="glyphicon glyphicon-plus"></i></button>
                      <!-- Modal -->
                  ...
                  @foreach($customer as $c)
                    <tr position="#" id="tr-customer-{{$c->id}}" data-customer-id="{{$c->id}}" >
                      ...
                      <td><button class="btn btn-default" onclick="editCustomer(this)" type="button"><i class="glyphicon glyphicon-pencil"></i></button>
                          <button class="btn btn-default" id="delCustomer" type="button"><a href="{{route('deleteCustomer',$c->id)}}" class="glyphicon glyphicon-remove" ></a></button>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
